...
<body>
	...
	<div id="modalDetailsItem01" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/01.jpg" alt="" class="img-fluid"></figure>
	...
	<div id="modalDetailsItem02" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/02.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
			<p>Ragu, Mozzarella</p>
		</div>
		<div class="footer">
	...
	<div id="modalDetailsItem03" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/03.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem04" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/04.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem05" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/05.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem06" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/06.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem07" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/07.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem08" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/08.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem09" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('img/gallery/grid-items-large/09.jpg') }}" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem10" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('img/gallery/grid-items-large/10.jpg') }}" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem11" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('img/gallery/grid-items-large/11.jpg') }}" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem12" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="{{ asset('') }}img/gallery/grid-items-large/12.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
