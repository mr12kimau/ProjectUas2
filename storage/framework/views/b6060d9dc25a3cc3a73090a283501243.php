...
<body>
	...
	<div id="page">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-6">
						<div id="logo">
							<h1><a href="<?php echo e(asset('img/logo Zhafira.jpg')); ?>" title="Zhafira">Zhafira</a></h1>
						</div>
					</div>
								...
								<li>
									...
									<ul>
										<li>
											...
											<ul>
												<li><a href="<?php echo e(asset('')); ?>pay-with-card-online/">Demo 1 - Filtering</a></li>
												<li><a href="<?php echo e(asset('')); ?>pay-with-card-online/order-2.php">Demo 2 - Sticky navigation</a></li>
											</ul>
										</li>
										<li>
											<span><a href="#">Pay with cash</a></span>
											<ul>
												<li><a href="<?php echo e(asset('')); ?>pay-with-cash-on-delivery/">Demo 1 - Filtering</a></li>
												<li><a href="<?php echo e(asset('')); ?>pay-with-cash-on-delivery/order-2.php">Demo 2 - Sticky navigation</a></li>
											</ul>
										</li>
									</ul>
								</li>
								<li><span><a href="<?php echo e(asset('')); ?>faq.html">Faq</a></span></li>
								<li><span><a href="<?php echo e(asset('')); ?>contacts.html">Contacts</a></span></li>
							</ul>
						</nav>
						<!-- Menu End -->
					</div>
													...
													<div class="col-6 pr-0">
														<div class="form-group">
															...
															<label class="cbx terms" for="cbxCashPayment">
																...
																<span>Accept<a href="<?php echo e(asset('')); ?>pdf/terms.pdf" class="terms-link" target="_blank">Terms</a>.</span>
															</label>
														</div>
													</div>
		...
		<footer class="main-footer">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-2">
						...
						<ul class="list-unstyled social-links">
							<li><a href="https://instagram.com/mr12kimau" class="social-link" target="_blank"><i class="icon icon-instagram"></i></a></li>
						</ul>
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col-md-4">
						<div id="copy">© M. Rizki Maulana</div>
					</div>
				</div>
			</div>
		</footer>
	...
	<div id="modalDetailsItem01" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/01.jpg" alt="" class="img-fluid"></figure>
	...
	<div id="modalDetailsItem02" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/02.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
			<p>Ragu, Mozzarella</p>
		</div>
		<div class="footer">
	...
	<div id="modalDetailsItem03" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/03.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem04" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/04.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem05" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/05.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem06" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/06.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem07" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/07.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem08" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/08.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem09" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('img/gallery/grid-items-large/09.jpg')); ?>" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem10" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('img/gallery/grid-items-large/10.jpg')); ?>" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem11" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('img/gallery/grid-items-large/11.jpg')); ?>" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<div id="modalDetailsItem12" class="modal-popup zoom-anim-dialog mfp-hide">
		...
		<div class="content pb-1">
			<figure><img src="<?php echo e(asset('')); ?>img/gallery/grid-items-large/12.jpg" alt="" class="img-fluid"></figure>
			<h6 class="mb-1">Ingredients</h6>
	...
	<script src="<?php echo e(asset('vendor/easing/js/easing.min.js')); ?>"></script>
	<script src="<?php echo e(asset('')); ?>vendor/parsley/js/parsley.min.js"></script>
	<script src="<?php echo e(asset('vendor/nice-select/js/jquery.nice-select.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/price-format/js/jquery.priceformat.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/theia-sticky-sidebar/js/ResizeSensor.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/theia-sticky-sidebar/js/theia-sticky-sidebar.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/mmenu/js/mmenu.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/magnific-popup/js/jquery.magnific-popup.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/float-labels/js/float-labels.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/jquery-wizard/js/jquery-ui-1.8.22.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/jquery-wizard/js/jquery.wizard.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/isotope/js/isotope.pkgd.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/scrollreveal/js/scrollreveal.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/lazyload/js/lazyload.min.js')); ?>"></script>
	<script src="<?php echo e(asset('vendor/sticky-kit/js/sticky-kit.min.js')); ?>"></script>
...
</html><?php /**PATH D:\Project\zhafira_order\resources\views/customers/index.blade.php ENDPATH**/ ?>