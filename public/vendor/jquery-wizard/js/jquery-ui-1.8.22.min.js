...
(function (a, b) {
            ...
            a.each(["Width", "Height"], function (c, d) {
                function h(b, c, d, f) {
                    return (
                        a.each(e, function () {
                            (c -=
                                parseFloat(a.curCSS(b, "padding" + this, !0)) ||
                                0),
                                d &&
                                    (c -=
                                        parseFloat(
            ...
            (g.options = a.extend(!0, {}, g.options)),
                (a[e][b].prototype = a.extend(
                    ...
                    g,
                    {
                        ...
                        widgetName: b,
                        widgetEventPrefix:
                            a[e][b].prototype.widgetEventPrefix || b,
                        widgetBaseClass: f,
                    },
                    d
                )),
            ...
            (a.widget.bridge = function (c, d) {
                a.fn[c] = function (e) {
                    ...
                    return (
                        (e =
                            !f && g.length
                                ? a.extend.apply(null, [!0, e].concat(g))
                                : e),
                        f && e.charAt(0) === "_"
                            ? h
                            : (f
                ...
                _mouseDown: function (b) {
                    ...
                    var d = this,
                        ...
                        f =
                            ...
                            b.target.nodeName
                                ? a(b.target).closest(this.options.cancel)
                                      .length
                                : !1;
                ...
                return this.helper ||
                    ...
                    : ((this.handle = this._getHandle(b)),
                      this.handle
                          ? (c.iframeFix &&
                                a(
                                    c.iframeFix === !0 ? "iframe" : c.iframeFix
                                ).each(function () {
                                    a(
                ...
                if (b.containment == "document" || b.containment == "window")
                    this.containment = [
                        ...
                        (b.containment == "document"
                            ...
                            : a(window).scrollLeft()) +
                            a(
                                b.containment == "document" ? document : window
                            ).width() -
                            this.helperProportions.width -
                            this.margins.left,
                        (b.containment == "document"
            ...
            _generatePosition: function (b) {
                ...
                if (this.originalPosition) {
                    ...
                    if (c.grid) {
                        var j = c.grid[1]
                            ? this.originalPageY +
                              Math.round((g - this.originalPageY) / c.grid[1]) *
                                  c.grid[1]
                            : this.originalPageY;
                        g = h
                        ...
                        var k = c.grid[0]
                            ? this.originalPageX +
                              Math.round((f - this.originalPageX) / c.grid[0]) *
                                  c.grid[0]
                            : this.originalPageX;
                        f = h
                        ...
                        if (!e.axis || e.axis != "x")
                            ...
                            e.scrollSensitivity
                                ? (d.scrollParent[0].scrollTop = f =
                                      d.scrollParent[0].scrollTop +
                                      e.scrollSpeed)
                                : b.pageY - d.overflowOffset.top <
                                      e.scrollSensitivity &&
                                  (d.scrollParent[0].scrollTop = f =
                                      d.scrollParent[0].scrollTop -
                                      e.scrollSpeed);
                        if (!e.axis || e.axis != "y")
                            d.overflowOffset.left +
                                d.scrollParent[0].offsetWidth -
                                b.pageX <
                            e.scrollSensitivity
                                ? (d.scrollParent[0].scrollLeft = f =
                                      d.scrollParent[0].scrollLeft +
                                      e.scrollSpeed)
                                : b.pageX - d.overflowOffset.left <
                                      e.scrollSensitivity &&
                                  (d.scrollParent[0].scrollLeft = f =
                                      d.scrollParent[0].scrollLeft -
                                      e.scrollSpeed);
                        ...
                        a.each(
                            ...
                            function () {
                                ...
                                f &&
                                    ...
                                    (this[e] = 1),
                                    (this[
                                        e == "isout" ? "isover" : "isout"
                                    ] = 0),
                                    this[e == "isover" ? "_over" : "_out"].call(
                                        this,
                                        c
                                    ),
                                    f &&
        ...
        a.widget("ui.resizable", a.ui.mouse, {
                    ...
                    var e = this._proportionallyResizeElements,
                        ...
                        j =
                            parseInt(d.element.css("left"), 10) +
                                (d.position.left - d.originalPosition.left) ||
                            null,
                        k =
                            parseInt(d.element.css("top"), 10) +
                                (d.position.top - d.originalPosition.top) ||
                            null;
                    c.animate ||
                        this.element.css(a.extend(i, { top: k, left: j })),
            ...
            a.ui.plugin.add("resizable", "containment", {
                start: function (b, d) {
                    ...
                    if (/document/.test(h) || h == document)
                        ...
                        var j = a(i),
                            k = [];
                        a(["Top", "Right", "Left", "Bottom"]).each(function (
                            a,
                            b
                        ) {
                ...
                resize: function (b, c) {
                    ...
                    var m = Math.abs(
                            (d._helper
                                ...
                                : d.offset.left - k.left) + d.sizeDiff.width
                        ),
                        n = Math.abs(
                            (d._helper
                                ? d.offset.top - k.top
                                : d.offset.top - g.top) + d.sizeDiff.height
                        ),
                        o =
                            d.containerElement.get(0) ==
                            d.element.parent().get(0),
                        p = /relative|absolute/.test(
                            d.containerElement.css("position")
                        );
            ...
            a.ui.plugin.add("resizable", "grid", {
                resize: function (b, c) {
                    ...
                    e.grid =
                        typeof e.grid == "number" ? [e.grid, e.grid] : e.grid;
                    var k =
                            Math.round((f.width - g.width) / (e.grid[0] || 1)) *
                            (e.grid[0] || 1),
                        l =
                            Math.round(
                                (f.height - g.height) / (e.grid[1] || 1)
                            ) * (e.grid[1] || 1);
                    /^(se|s|e)$/.test(i)
    ...
    (function (a, b) {
        a.widget("ui.sortable", a.ui.mouse, {
            ...
            _mouseCapture: function (b, c) {
                ...
                a.data(b.target, d.widgetName + "-item") == f &&
                    (e = a(b.target));
                if (!e) return !1;
                ...
                return (
                    (this.currentItem = e), this._removeCurrentsFromItems(), !0
                );
            },
            ...
            serialize: function (b) {
                ...
                return (
                    ...
                    a(c).each(function () {
                        var c = (
                            a(b.item || this).attr(b.attribute || "id") || ""
            ...
            _contactContainers: function (b) {
                ...
                for (var e = this.containers.length - 1; e >= 0; e--) {
                    if (
                        ...
                        continue;
                    if (
                        this._intersectsWith(this.containers[e].containerCache)
                    ) {
                        if (
                            c &&
                            a.ui.contains(
                ...
                if (this.containers.length === 1)
                    ...
                    var f = 1e4,
                        ...
                        h =
                            this.positionAbs[
                                this.containers[d].floating ? "left" : "top"
                            ];
            ...
            (a.effects.animateClass = function (b, c, d, e) {
                ...
                a.extend(a.effects, {
                    ...
                    restore: function (a, b) {
                        for (var c = 0; c < b.length; c++)
                            b[c] !== null &&
                                a.css(b[c], a.data("ec.storage." + b[c]));
                    },
                ...
                a.fn.extend({
                    ...
                    toggle: function (b) {
                        ...
                        return (
                            (c[1].mode = "toggle"), this.effect.apply(this, c)
                        );
                    },
                    cssUnit: function (b) {
                        var c = this.css(b),
                ...
                a.extend(a.easing, {
                    ...
                    easeInBounce: function (b, c, d, e, f) {
                        return (
                            e - a.easing.easeOutBounce(b, f - c, 0, e, f) + d
                        );
                    },
                    ...
                    easeInOutBounce: function (b, c, d, e, f) {
                        return c < f / 2
                            ...
                            : a.easing.easeOutBounce(b, c * 2 - f, 0, e, f) *
                                  0.5 +
                                  e * 0.5 +
                                  d;
                    },
    ...
    (function (a, b) {
        a.effects.explode = function (b) {
            return this.queue(function () {
                var c = b.options.pieces
                        ? Math.round(Math.sqrt(b.options.pieces))
                        : 3,
                    d = b.options.pieces
                        ? Math.round(Math.sqrt(b.options.pieces))
                        : 3;
        ...
        a.effects.pulsate = function (b) {
            return this.queue(function () {
                ...
                g || (c.css("opacity", 0).show(), (h = 1)),
                    ((d == "hide" && g) || (d == "show" && !g)) && e--;
                for (var i = 0; i < e; i++)
                    c.animate({ opacity: h }, f, b.options.easing),
                        (h = (h + 1) % 2);
            ...
            return this.queue(function () {
                ...
                a.extend(b.options, {
                    ...
                    from:
                        d == "hide"
                            ? g
                            : { height: g.height * f, width: g.width * f },
                }),
            ...
            (a.effects.scale = function (b) {
                return this.queue(function () {
                    ...
                    (c.to = { height: i.height * j.y, width: i.width * j.x }),
                        b.options.fade &&
                            (e == "show" &&
                                ((c.from.opacity = 0), (c.to.opacity = 1)),
                            e == "hide" &&
                                ((c.from.opacity = 1), (c.to.opacity = 0))),
                        (d.from = c.from),
                        (d.to = c.to),
                        (d.mode = e),
            ...
            (a.effects.size = function (b) {
                return this.queue(function () {
                    ...
                    if (l == "box" || l == "both")
                        q.from.y != q.to.y &&
                            ((d = d.concat(h)),
                            (c.from = a.effects.setTransition(
                                c,
                                h,
                                q.from.y,
                                c.from
                            )),
                            (c.to = a.effects.setTransition(
                                c,
                                h,
                                q.to.y,
                                c.to
    ...
    (function (a, b) {
        a.effects.shake = function (b) {
            return this.queue(function () {
                ...
                for (var p = 1; p < h; p++)
                    c.animate(m, i, b.options.easing).animate(
                        n,
                        i,
                        b.options.easing
                    );
        ...
        a.widget("ui.accordion", {
            ...
            _create: function () {
                ...
                (b.active = b
                    ...
                    a.browser.safari ||
                        b.headers.find("a").attr("tabIndex", -1),
                    c.event &&
                        b.headers.bind(
                            c.event.split(" ").join(".accordion ") +
                                ".accordion",
                            function (a) {
            ...
            _toggle: function (b, c, d, e, f) {
                ...
                if (h.animated) {
                    ...
                    h.collapsible && e
                        ...
                        (h.animated = a.isFunction(h.proxied)
                            ? h.proxied(j)
                            : h.proxied),
                    ...
                    h.collapsible && e ? b.toggle() : (c.hide(), b.show()),
                        i(!0);
                c
                    .prev()
                    .attr({
                        ...
                        (i = j[0].style.width),
                            j.width(
                                j.parent().width() -
                                    ...
                                    (parseFloat(j.css("borderLeftWidth")) ||
                                        0) -
                                    (parseFloat(j.css("borderRightWidth")) || 0)
                            ),
                            a.each(h, function (c, d) {
                                g[d] = "hide";
                                var e = ("" + a.css(b.toShow[0], d)).match(
                                    /^([\d+-.]+)(.*)$/
                                );
        ...
        a.widget("ui.autocomplete", {
            ...
            _suggest: function (b) {
                ...
                this._renderMenu(c, b),
                    ...
                    this._resizeMenu(),
                    c.position(
                        a.extend({ of: this.element }, this.options.position)
                    ),
        ...
        a.widget("ui.menu", {
            ...
            activate: function (a, b) {
                ...
                if (this.hasScroll()) {
                    ...
                    c < 0
                        ...
                        : c >= e &&
                          this.element.scrollTop(d + c - e + b.height());
                }
                (this.active = b
                    .eq(0)
                    .children("a")
            ...
            nextPage: function (b) {
                if (this.hasScroll()) {
                    ...
                    e.length ||
                        (e = this.element.children(".ui-menu-item:last")),
                        this.activate(b, e);
                } else
                    this.activate(
                        b,
            ...
            previousPage: function (b) {
                if (this.hasScroll()) {
                    ...
                    e.length ||
                        (e = this.element.children(".ui-menu-item:first")),
                        this.activate(b, e);
                } else
                    this.activate(
                        b,
            ...
            _create: function () {
                this.element
                    ...
                    typeof this.options.disabled != "boolean"
                        ? (this.options.disabled =
                              !!this.element.propAttr("disabled"))
                        : this.element.propAttr(
                              "disabled",
                              this.options.disabled
                          ),
    ...
    (function ($, undefined) {
        ...
        $.extend(Datepicker.prototype, {
                ...
                a.dpDiv
                    ...
                    f > 1 &&
                        a.dpDiv
                            ...
                            .css("width", g * f + "em"),
                    a.dpDiv[
                        (e[0] != 1 || e[1] != 1 ? "add" : "remove") + "Class"
                    ]("ui-datepicker-multi"),
                    a.dpDiv[
                        (this._get(a, "isRTL") ? "add" : "remove") + "Class"
                    ]("ui-datepicker-rtl"),
            ...
            parseDate: function (a, b, c) {
                ...
                var e =
                        (c ? c.dayNamesShort : null) ||
                        this._defaults.dayNamesShort,
                    f = (c ? c.dayNames : null) || this._defaults.dayNames,
                    g =
                        (c ? c.monthNamesShort : null) ||
                    ...
                    p = function (a, c, d) {
                        ...
                        $.each(e, function (a, c) {
                            var d = c[1];
                            if (
                                b.substr(r, d.length).toLowerCase() ==
                                d.toLowerCase()
                            )
                            ...
                            switch (i[2] || "d") {
                                ...
                                case "M":
                                    (f += parseInt(i[1], 10)),
                                        (g = Math.min(
                                            g,
                                            $.datepicker._getDaysInMonth(e, f)
                                        ));
                                    break;
                                case "y":
                                case "Y":
            ...
            _setDate: function (a, b, c) {
                var d = !b,
                    ...
                    g = this._restrictMinMax(
                        a,
                        this._determineDate(a, b, new Date())
                    );
                    ...
                    var a = {
                        ...
                        selectMonth: function () {
                            return (
                                window[
                                    "DP_jQuery_" + dpuuid
                                ].datepicker._selectMonthYear(c, this, "M"),
                                !1
                            );
                        },
                        selectYear: function () {
                            return (
                                window[
                                    "DP_jQuery_" + dpuuid
                                ].datepicker._selectMonthYear(c, this, "Y"),
                                !1
                            );
                        },
                    };
            ...
            _generateHTML: function (a) {
                ...
                for (var L = 0; L < g[0]; L++) {
                    ...
                    for (var N = 0; N < g[1]; N++) {
                        ...
                        this.maxRows = X;
                        var Y = this._daylightSavingAdjust(
                            new Date(o, n, 1 - V)
                        );
                        for (var Z = 0; Z < X; Z++) {
                            Q += "<tr>";
                            ...
                            for (var S = 0; S < 7; S++) {
                                var ba = F
                                        ? F.apply(a.input ? a.input[0] : null, [
                                              Y,
                                          ])
                                        : [!0, ""],
                                    bb = Y.getMonth() != n,
            ...
            _generateMonthYearHeader: function (a, b, c, d, e, f, g, h) {
                ...
                if (f || !i)
                    m +=
                        '<span class="ui-datepicker-month">' + g[b] + "</span>";
                else {
                ...
                if (!a.yearshtml) {
                    ...
                    if (f || !j)
                        l +=
                            '<span class="ui-datepicker-year">' + c + "</span>";
                    else {
            ...
            _canAdjustMonth: function (a, b, c, d) {
                ...
                return (
                    b < 0 &&
                        f.setDate(
                            this._getDaysInMonth(f.getFullYear(), f.getMonth())
                        ),
                    this._isInRange(a, f)
                );
            },
        ...
        a.widget("ui.dialog", {
            ...
            _create: function () {
                (this.originalTitle = this.element.attr("title")),
                    typeof this.originalTitle != "string" &&
                        (this.originalTitle = ""),
                    (this.options.title =
            ...
            moveToTop: function (b, c) {
                ...
                return (e.modal && !b) || (!e.stack && !e.modal)
                    ? d._trigger("focus", c)
                    : (e.zIndex > a.ui.dialog.maxZ &&
                          (a.ui.dialog.maxZ = e.zIndex),
                      d.overlay &&
                          ((a.ui.dialog.maxZ += 1),
                          d.overlay.$el.css(
                              "z-index",
            ...
            _size: function () {
                ...
                this.element
                    .show()
                    .css({ width: "auto", minHeight: 0, height: 0 }),
                    b.minWidth > b.width && (b.width = b.minWidth),
                    (c = this.uiDialog
                        .css({ height: "auto", width: b.width })
                        .height()),
            ...
            a.extend(a.ui.dialog.overlay, {
                ...
                destroy: function (b) {
                    ...
                    c != -1 &&
                        this.oldInstances.push(this.instances.splice(c, 1)[0]),
                        this.instances.length === 0 &&
                ...
                this.each(function () {
                    var c = a(this),
                        ...
                        o =
                            d +
                            h +
                            (parseInt(a.curCSS(this, "marginRight", !0)) || 0),
                        p =
                            g +
                            i +
                            (parseInt(a.curCSS(this, "marginBottom", !0)) || 0),
                        q = a.extend({}, n),
                        r;
                    b.my[0] === "right"
                        ? (q.left -= d)
                    ...
                    left: function (b, c) {
                        ...
                        b.left =
                            e > 0
                                ? b.left - e
                                : Math.max(
                                      b.left - c.collisionPosition.left,
                                      b.left
                                  );
                    },
                    top: function (b, c) {
        ...
        a.widget("ui.progressbar", {
            ...
            _refreshValue: function () {
                var a = this.value(),
                    b = this._percentage();
                this.oldValue !== a &&
                    ((this.oldValue = a), this._trigger("change")),
                    this.valueDiv
                        .toggle(a > this.min)
        ...
        a.widget("ui.tabs", {
            ...
            _cookie: function () {
                var b =
                    this.cookie ||
                    (this.cookie =
                        this.options.cookie.name || "ui-tabs-" + f());
            ...
            _tabify: function (c) {
                ...
                (this.list = this.element.find("ol,ul").eq(0)),
                    ...
                    this.anchors.each(function (b, c) {
                        ...
                        h &&
                            ...
                            ((g = c.hash), (c.href = g));
                        if (f.test(g))
                            d.panels = d.panels.add(
                                d.element.find(d._sanitizeSelector(g))
                            );
                        else if (g && g !== "#") {
                        ...
                        ? (this.element.addClass(
                          ...
                          e.selected === b
                              ? (location.hash &&
                                ...
                                (e.selected =
                                    e.selected || (this.lis.length ? 0 : -1)))
                              : e.selected === null && (e.selected = -1),
                          (e.selected =
                              (e.selected >= 0 && this.anchors[e.selected]) ||
                              e.selected < 0
                                  ? e.selected
                                  : 0),
                          (e.disabled = a
                          ...
                          a.inArray(e.selected, e.disabled) != -1 &&
                              e.disabled.splice(
                                  a.inArray(e.selected, e.disabled),
                                  1
                              ),
                          this.panels.addClass("ui-tabs-hide"),
                          this.lis.removeClass(
                ...
                for (var g = 0, h; (h = this.lis[g]); g++)
                    a(h)[
                        a.inArray(g, e.disabled) != -1 &&
                        !a(h).hasClass("ui-tabs-selected")
                            ? "addClass"
                            : "removeClass"
                    ]("ui-state-disabled");
                ...
                if (e.event !== "mouseover") {
                    var i = function (a, b) {
                            b.is(":not(.ui-state-disabled)") &&
                                b.addClass("ui-state-" + a);
                        },
                        j = function (a, b) {
                    ...
                    (this.xhr = a.ajax(
                        a.extend({}, d.ajaxOptions, {
                            ...
                            success: function (f, g) {
                                c.element
                                    .find(c._sanitizeSelector(e.hash))
                                    .html(f),
                                    c._cleanup(),
